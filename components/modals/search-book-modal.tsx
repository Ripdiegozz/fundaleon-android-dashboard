...
export function SearchBookModal () {
    ...
    const isModalOpen = isOpen && type === 'searchBook';
      ...
      <Center>
        ...
        >
          ...
          <AlertDialogContent padding='$4'>
            <AlertDialogHeader>
              <Heading size='lg'>Buscar un título</Heading>
              <AlertDialogCloseButton>
            ...
            <AlertDialogBody>
              <Text size='sm'>
                Ingresa el ISBN del libro que deseas buscar. Si no lo conoces, puedes buscarlo por título.
              </Text>
            </AlertDialogBody>
